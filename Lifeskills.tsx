  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.courseHeader}>
        ...
        <Image
          source={require('./assets/life_skills.png')}
          style={styles.courseImage}
        />
        <Text style={styles.courseCode}>Course Code: LFS5322</Text>
      </View>
...
export default LifeSkillsCoursePage;
