  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.courseHeader}>
        ...
        <Image source={require('./assets/firstaid.png')} style={styles.courseImage} />
        <Text style={styles.courseCode}>Course Code: FA5432</Text>
      </View>
...
export default FirstAidCoursePage;
