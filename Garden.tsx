...
const GardenMaintenanceCoursePage = () => {
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.courseHeader}>
        ...
        />
        <Text style={styles.courseCode}>Course Code: GM7832</Text>
      </View>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.sectionText}>
          To provide basic knowledge of watering, pruning, and planting in a
          domestic garden.
        </Text>
      </View>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.list}>
          <Text style={styles.listItem}>
            Water restrictions and the watering requirements of indigenous and
            exotic plants
          </Text>
...
export default GardenMaintenanceCoursePage;
